...
test_data_config = dict(
    ...
    ann_file=data_root + 'lyft_infos_val_bevdet_format_sync+raw.pkl')
    # ann_file=data_root + 'lyft_infos_val_bevdet_format.pkl')
...
data = dict(
    ...
    train=dict(
        data_root=data_root,
        ann_file=data_root + 'lyft_infos_train_bevdet_format_sync+raw.pkl',
