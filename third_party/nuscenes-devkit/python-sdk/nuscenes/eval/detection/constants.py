...
LYFT_ATTRIBUTE_NAMES = ['object_action_lane_change_right', 'object_action_running', 
                        'object_action_lane_change_left', 'object_action_parked', 
                        'object_action_standing', 'object_action_right_turn', 
                        'object_action_gliding_on_wheels', 'object_action_loss_of_control', 
                        'object_action_u_turn', 'object_action_sitting', 
                        'object_action_walking', 'object_action_stopped', 
                        'object_action_left_turn', 'object_action_reversing', 
                        'is_stationary', 'object_action_driving_straight_forward', 
                        'object_action_abnormal_or_traffic_violation', 'object_action_other_motion']
