...
def torch_init_model(model, total_dict, key, rank=0, verbose=True):
...
def get_lr_cos_schedule_with_warmup(optimizer, num_warmup_steps, total_steps, min_lr, last_epoch=-1):
