...
data = dict(
    ...
    train=dict(
        data_root=data_root,
        # ann_file=data_root + 'bevdetv3-nuscenes_infos_train_general_3cls.pkl',
        ann_file=data_root + 'bevdetv3-nuscenes_infos_train_general_3cls_sync+raw.pkl',
