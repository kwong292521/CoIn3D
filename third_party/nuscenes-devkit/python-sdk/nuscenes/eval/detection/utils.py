...
def category_to_detection_name_nuscenes_gen3cls(category_name: str) -> Optional[str]:
    detection_mapping = {
        'movable_object.barrier': 'barrier',
...
def category_to_detection_name_lyft_gen3cls(category_name: str) -> Optional[str]:
    # detection_mapping = {
    #     'car': 'car',
...
def category_to_detection_name_lyft(category_name: str) -> Optional[str]:
    detection_mapping = {
        'car' : 'car', 
        'truck' : 'truck', 
        'bus' : 'bus', 
        'emergency_vehicle' : 'trailer', 
...
def category_to_detection_name_waymo_gen3cls(category_name: str) -> Optional[str]:
    detection_mapping = {
        'car': 'car',
        'pedestrian': 'pedestrian',
        'cyclist': 'motorcycle',
